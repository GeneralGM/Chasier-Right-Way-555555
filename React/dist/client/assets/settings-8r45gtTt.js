      ...
      <body class="p-4">
        <div class="receipt-container bg-white rounded-lg shadow-lg px-8 py-10 max-w-2xl mx-auto">
          ...
          <div class="grid grid-cols-2 gap-4 mb-6 text-center text-sm">
            ...
            <div>
              <div class="text-gray-500 mb-0.5">التاريخ</div>
              <div class="font-bold text-black text-xs">${G}</div>
            </div>
            <div>
            <div>
      ...
      <html dir="rtl">
        ...
        <body onload="setTimeout(() => { window.print(); window.close(); }, 500);">
          ...
          <table>
            ...
            <tr><td>فاست فود (مبيعات)</td><td class="bold">${z.toFixed(2)}</td></tr>
            <tr><td>طلبات Talabat (مبيعات)</td><td class="bold">${H.toFixed(2)}</td></tr>
